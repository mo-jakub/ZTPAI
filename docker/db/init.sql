...
ALTER TABLE ONLY public.sessions
    ADD CONSTRAINT fk_9a609d136b3ca4b FOREIGN KEY (id_user) REFERENCES public."user"(id);
...
ALTER TABLE ONLY public.admins
    ADD CONSTRAINT fk_a2e0150f6b3ca4b FOREIGN KEY (id_user) REFERENCES public."user"(id);
